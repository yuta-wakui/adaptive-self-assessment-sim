...
LOG_STATS_REQUIRED_COLS = [
    "num_answered_questions",
    "num_complemented_questions",
    "complement_accuracy",
    "response_time",
]
...
def summarize_prediction_metrics(
    ...
    """
    Summarize prediction performance metrics from logs DataFrame.
    Parameters:
    -----------
        logs_df: pd.DataFrame
    ...
    -------
        metrics: Dict[str, Any]
            Dictionary of summarized prediction metrics
    Required columns:
        - actual_ra
        - predicted_ra
        - is_confident
    ...
    validate_columns(logs_df, PRED_REQUIRED_COLS, "logs_df")
...
def summarize_log_stats(
    logs_df: pd.DataFrame,
    total_questions: int,
) -> Dict[str, Any]:
    """
    Summarize log/statistics metrics from logs DataFrame.
    Parameters:
    -----------
        logs_df: pd.DataFrame
            Logs DataFrame containing simulation results
    ...
    -------
        metrics: Dict[str, Any]
            Dictionary of summarized log/statistics metrics
    Required columns:
        - num_answered_questions
        - num_complemented_questions
        - complement_accuracy
    ...
    validate_columns(logs_df, LOG_STATS_REQUIRED_COLS, "logs_df")
    ...
    avg_comp_acc = (
        float(valid_comp["complement_accuracy"].mean())
