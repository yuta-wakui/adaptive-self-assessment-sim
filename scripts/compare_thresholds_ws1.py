...
from run_ws1_sim import run_simulations as run_ws1_sim
...
def compare_thresholds_ws1(
    ...
    for rc, ri in product(RC_VALUES, RI_VALUES):
        ...
        sim_output_path = f"outputs/results_csv/ws1/sim_results/ws1_simulation_result_rc{rc_str}_ri{ri_str}.csv"
